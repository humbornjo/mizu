...
const (
	...
	FileServiceName = "barapp.file.v1.FileService"
)
...
const (
	...
	FileServiceGetFileProcedure = "/barapp.file.v1.FileService/GetFile"
	// FileServiceUploadFileProcedure is the fully-qualified name of the FileService's UploadFile RPC.
	FileServiceUploadFileProcedure = "/barapp.file.v1.FileService/UploadFile"
	// FileServiceDownloadFileProcedure is the fully-qualified name of the FileService's DownloadFile
	// RPC.
	FileServiceDownloadFileProcedure = "/barapp.file.v1.FileService/DownloadFile"
)

// FileServiceClient is a client for the barapp.file.v1.FileService service.
...
// NewFileServiceClient constructs a client for the barapp.file.v1.FileService service. By default,
...
func NewFileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FileServiceClient {
	...
	fileServiceMethods := v1.File_barapp_file_v1_file_proto.Services().ByName("FileService").Methods()
...
// GetFile calls barapp.file.v1.FileService.GetFile.
...
// UploadFile calls barapp.file.v1.FileService.UploadFile.
...
// DownloadFile calls barapp.file.v1.FileService.DownloadFile.
...
// FileServiceHandler is an implementation of the barapp.file.v1.FileService service.
...
func NewFileServiceHandler(svc FileServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/barapp.file.v1.FileService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFileServiceHandler) GetFile(context.Context, *connect.Request[v1.GetFileRequest]) (*connect.Response[v1.GetFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("barapp.file.v1.FileService.GetFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) UploadFile(context.Context, *connect.ClientStream[v1.UploadFileRequest]) (*connect.Response[v1.UploadFileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("barapp.file.v1.FileService.UploadFile is not implemented"))
}
...
func (UnimplementedFileServiceHandler) DownloadFile(context.Context, *connect.Request[v1.DownloadFileRequest], *connect.ServerStream[httpbody.HttpBody]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("barapp.file.v1.FileService.DownloadFile is not implemented"))
}
